Ext.define('Ext.ux.form.MyEditor', {
    ...
    createToolbar: function(){
        ...
        me.toolbar.insert(17, {
            xtype: 'button',
            icon: '/Scripts/ext-4.1/resources/images/picture.gif',
    ...
    showImgUploader: function(){
        ...
        var imgform = Ext.create('Ext.tab.Panel', {
            ...
            items: [{
                title: '本地图片',
                icon: '/Scripts/ext-4.1/resources/images/computer.png',
                layout: 'fit',
                items: [{
                    xtype: 'form',
                    border: false,
...
//                                }
                                ...
                                f.submit({
                                    waitMsg: '图片上传中..',
                                    waitTitle: '提示',
                                    url:'/Validate/Upfile', //editor.url + '?sign=HtmlEditor', //点击插入执行的方法,将图片保存到服务器上
                ...
                title: '远程图片',
                icon: '/Scripts/ext-4.1/resources/images/link.png',
                layout: 'fit',
                items: [{
                    xtype: 'form',
                    border: false,
